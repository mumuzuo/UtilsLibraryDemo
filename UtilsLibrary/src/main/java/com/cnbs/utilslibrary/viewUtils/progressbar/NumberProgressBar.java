...
import static com.cnbs.utilslibrary.viewUtils.progressbar.NumberProgressBar.ProgressTextVisibility.Invisible;
import static com.cnbs.utilslibrary.viewUtils.progressbar.NumberProgressBar.ProgressTextVisibility.Visible;
...
//        mCurrentDrawText = String.format("%d", getProgress() * 100 / getMax());
        mCurrentDrawText = accuracy(getProgress(),getMax());
//        mCurrentDrawText = mPrefix + mCurrentDrawText + mSuffix;
    ...
    public void setProgressAndMax(int progress,int maxProgress) {
        if (maxProgress>0){
            this.mMaxProgress = maxProgress;
            invalidate();
            if (progress <= getMax() && progress >= 0) {
